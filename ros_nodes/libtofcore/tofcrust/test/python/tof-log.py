...
parser.add_argument('--protocol-version', default=pytofcrust.Sensor.DEFAULT_PROTOCOL_VERSION, type=int, help="Protocol version to use 0 or 1")
...
sensor = pytofcrust.Sensor(protocol_version=args.protocol_version, port_name=args.port_name)
